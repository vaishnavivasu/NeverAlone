...
import com.example.user.neveralone2.User;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_USER_EMAIL, user.get_user_email());
        values.put(COLUMN_USER_PASSWORD, user.get_user_password());
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.set_user_email(cursor.getString(cursor.getColumnIndex(COLUMN_USER_EMAIL)));
                user.set_user_password(cursor.getString(cursor.getColumnIndex(COLUMN_USER_PASSWORD)));
